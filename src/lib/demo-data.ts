...
export const recipes: Recipe[] = [
  { externalId: "demo-one-pot-pasta", title: "One pot pasta", image: img("photo-1621996346565-e3dbc646d9a9"), preparationTime: 25, servings: 2, missingCount: 0, missingIngredients: [], nutrition: { calories: 620, protein: 22, carbs: 78, fat: 24 }, ingredients: [] },
  { externalId: "demo-salade-pois-chiches", title: "Salade de pois chiches", image: img("photo-1512621776951-a57141f2eefd"), preparationTime: 15, servings: 2, missingCount: 0, missingIngredients: [], nutrition: { calories: 460, protein: 18, carbs: 52, fat: 19 }, ingredients: [] },
  { externalId: "demo-omelette-legumes", title: "Omelette aux légumes", image: img("photo-1525351484163-7529414344d8"), preparationTime: 12, servings: 2, missingCount: 0, missingIngredients: [], nutrition: { calories: 390, protein: 27, carbs: 12, fat: 26 }, ingredients: [] },
  ...
  { externalId: "demo-bolognaise", title: "Bolognaise", image: img("photo-1622973536968-3ead9e780960"), preparationTime: 35, servings: 4, missingCount: 2, nutrition: { calories: 720, protein: 34, carbs: 86, fat: 22 }, ingredients: [] },
